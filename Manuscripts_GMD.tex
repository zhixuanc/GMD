%%xx General points
%%xx 0 Some suggestions in the text itself are shown with "xx" -- so if you just search for "xx" you will find them
%%xx 1 Make sure tenses match throughout
%%xx 2 use \citet for citations in-line (text), e.g., "\citet{monaghanpaper} found that SPH is great...", not "Monaghan \citep{monaghanpaper} found that SPH is great..."
...
%%xx 4 You often seem to forget to put a space between paragraphs.  LaTeX of course does not recognize a <return> as a paragraph delimiter, nor is it proper to end a normal paragraph with \\ or %
