...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=12cm]{Interface}
...
\DIFdelendFL \DIFaddbeginFL \end{minipage}%DIF > 
    ...
    \DIFaddbeginFL \end{minipage}%DIF >   
    \DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Dimensionless concetration distribution }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The left plot is normalized jet width (which determined based on velocity) }\DIFaddendFL along \DIFdelbeginFL \DIFdelFL{centraline}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the centerline}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{The right plot shows normalized concentration along the centerline.}\DIFaddendFL }
